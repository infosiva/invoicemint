...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body className="antialiased">{children}<BackToTop accentColor="#6366f1" /><Script defer data-site="invoicemint.cloud" src="http://31.97.56.148:3098/t.js" strategy="afterInteractive" /><FeedbackWidget siteName="InvoiceMint" /></body>
    </html>
  )
}
